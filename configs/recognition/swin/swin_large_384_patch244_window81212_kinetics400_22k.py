...
data_root_val = 'data/kinetics400/val_416'
ann_file_train = 'data/kinetics400/kinetics400_train_list.txt'
ann_file_val = 'data/kinetics400/val_416_subset.txt' # 'data/kinetics400/val_256.txt'
ann_file_test = 'data/kinetics400/val_416.txt'
img_norm_cfg = dict(
